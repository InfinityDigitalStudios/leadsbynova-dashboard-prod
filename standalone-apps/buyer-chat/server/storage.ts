import { type User, type InsertUser, type FormSubmission, type InsertFormSubmission, type ChatMessage, type InsertChatMessage, type Lead, type InsertLead, type Event, type InsertEvent, leads, events, chatMessages } from "../shared/schema.js";
